...
const strategy = [
  "Built a seamless marketing–sales workflow.",
  "Created dashboards to track and manage leads.",
  "Automated lead follow-ups and internal reporting.",
];

const results = [
  "Revenue growth in Q3 2025: 41%",
  "Reduction in lead response time: 37%",
  "2.3× improvement in campaign-to-sales handoff",
  "Decrease in team time loss: 22%",
];

export default function HsOrgRevenue() {
  document.title = "HS.ORG - Laith Dawara";
  return (
    <div className="bg-black text-white min-h-screen py-16">
      <Container>
        ...
        <div className="flex items-start gap-6 mb-10">
          <span className="font-extrabold text-[5rem] leading-none text-primary select-none">03.</span>
          <div className="pt-4">
            <p className="text-gray-400 uppercase tracking-widest text-sm font-semibold mb-1">Case Study</p>
            <h1 className="text-4xl font-bold font-serif">HS.ORG</h1>
          </div>
        </div>
        ...
        <div className="max-w-3xl space-y-10 text-gray-300 leading-relaxed text-[1.05rem]">
          ...
          <section className="space-y-3">
            <p>
              ...
              HS.ORG – Scholarships &amp; Learning Platform
            </p>
            <p>
              <span className="text-white font-semibold">Objective: </span>
              Increase revenue through effective integration between marketing and sales teams.
            </p>
          </section>

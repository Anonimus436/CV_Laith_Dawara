...
const strategy = [
  "Captured leads via WhatsApp and an existing customer database.",
  "Used marketing messages highlighting service scarcity and credibility.",
  "Targeted audiences based on geographic location in Germany.",
];

const results = [
  "230 qualified leads generated within 10 days",
  "Cost per Lead (CPL): €7.3",
  "14% booked on-site or virtual visits",
];

export default function EazySalesLeadGen() {
  document.title = "Eazy Sales - Laith Dawara";
  return (
    <div className="bg-black text-white min-h-screen py-16">
      <Container>
        ...
        <div className="flex items-start gap-6 mb-10">
          <span className="font-extrabold text-[5rem] leading-none text-primary select-none">02.</span>
          <div className="pt-4">
            <p className="text-gray-400 uppercase tracking-widest text-sm font-semibold mb-1">Case Study</p>
            <h1 className="text-4xl font-bold font-serif">Lead Generation – EazySales GmbH</h1>
          </div>
        </div>
        ...
        <div className="max-w-3xl space-y-10 text-gray-300 leading-relaxed text-[1.05rem]">
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              Acquire high-intent leads to purchase products and promote the company's offerings.
            </p>
          </section>
          ...
          <section>
            <p>
              ...
              Meta Ads – WhatsApp – Direct Calls
            </p>
          </section>

...
const results = [
  "Community growth +38%",
  "Engagement rate improved to 5.8% (up from 2.1%)",
  "Increase in campaign participation ×4",
  "21% of community members converted into qualified leads",
];

const strategy = [
  "Launched weekly interactive content to spark conversations and user participation.",
  "Scheduled posts based on detailed engagement analytics for optimal reach and timing.",
  "Delivered comprehensive monthly reports to guide editorial and content direction.",
];

export default function HadayaCommunityGrowth() {
  document.title = "Hadaya - Laith Dawara";
  return (
    <div className="bg-black text-white min-h-screen py-16">
      <Container>
        ...
        <div className="flex items-start gap-6 mb-10">
          <span className="font-extrabold text-[5rem] leading-none text-primary select-none">01.</span>
          <div className="pt-4">
            <p className="text-gray-400 uppercase tracking-widest text-sm font-semibold mb-1">Case Study</p>
            <h1 className="text-4xl font-bold font-serif">Hadaya – Community Growth</h1>
          </div>
        </div>
        ...
        <div className="max-w-3xl space-y-10 text-gray-300 leading-relaxed text-[1.05rem]">
          ...
          <section className="space-y-3">
            <p>
              ...
              Hadaya – Gift &amp; Services Platform
            </p>
            <p>
              <span className="text-white font-semibold">Objective: </span>
              Expand the brand's community, foster meaningful connections and increase both
              engagement and sales through targeted campaigns.
            </p>
          </section>
